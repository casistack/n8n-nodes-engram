...
export class EngramTrigger implements INodeType {
	description: INodeTypeDescription = {
		...
		group: ['trigger'],
		version: 1,
		description: 'Triggers when new entities, relationships, or episodes are added to the knowledge graph',
		defaults: {
			name: 'Engram Trigger',
		},
		polling: true,
		...
		properties: [
			...
			},
			{
				...
				default: '',
				description:
					'Only trigger for this group/session. Leave empty to watch all groups.',
			},
		],
	};
